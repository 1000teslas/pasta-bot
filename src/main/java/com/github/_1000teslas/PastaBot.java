...
public class PastaBot extends ListenerAdapter {
    ...
    static final String HE_BOOMED_ME = "Overheard in Cavs locker room after Game 7: “He got me,” LeBron said of Tatum's dunk over him. \"That f***ing Tatum boomed me.\" LeBron added, “He’s so good,” repeating it four times. LeBron then said he wanted to add Tatum to the list of players he works out with this summer.";
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        if (content.startsWith("pasta")) {
            ...
            channel.sendMessage(switch (content) {
                ...
                case "clap bombs" -> CLAP_BOMBS_PASTA;
